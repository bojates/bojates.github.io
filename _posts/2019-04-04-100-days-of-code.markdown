...
**Today's Progress**: OOP 21. Codewars. 

**Thoughts**: Getting my head around most of the OOP concepts now. 

### Day 52: 4 Jul 2019 (Fri)

**Today's Progress**: Working through the 80 OOP problems. Did 60 of them. 

**Thoughts**: Some of these seem incredibly trivial, and then a couple seem to introduce something we haven't come across before. 
